...
const getSubscriptionAlerts = asyncHandler(async (req, res) => {
  const summary = await insightsService.getInsightsSummary(req.userId);
...
const getWeekendWeekday = asyncHandler(async (req, res) => {
  const summary = await insightsService.getInsightsSummary(req.userId);
...
const evaluatePurchase = asyncHandler(async (req, res) => {
...
const getMoodCorrelation = asyncHandler(async (req, res) => {
  const userId = req.userId;
  const now = new Date();
